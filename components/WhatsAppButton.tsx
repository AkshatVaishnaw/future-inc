  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center justify-end gap-3">
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="px-4 py-2 rounded-xl bg-zinc-900 border border-white/10 text-white text-sm font-medium whitespace-nowrap shadow-xl"
          >
            Chat on WhatsApp
          </motion.div>
        )}
      ...
      <motion.a
        ...
        aria-label="Chat with Future Inc on WhatsApp"
